...
public class Player : MonoBehaviour
{
    ...
    public List<Transform> HairsParentList;
    public List<Transform> FaceParentList;
    public List<Transform> CharactersList;
    public List<Avatar> CharactersAvatarList;

    public WeaponListScript CurrentCharacter;
